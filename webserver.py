...
import cgi
# Import CRUD Operations from previous lesson
    ...
    def do_GET(self):
        try:
            ...
            if self.path.endswith("/restaurants"):
                ...
                output =""
                output += "<html><body>"
                output += "Click here to add a new restaurant... <a href = '/restaurants/new' >Add Restaurant</a>"
                output += "<br>"
            ...
            if self.path.endswith("/delete"):
                ...
                self.send_error(404, "File Not Found Stuart... %s" % self.path)
